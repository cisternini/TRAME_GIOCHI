...
\section{NPC}
    ...
    \newpage
        ...
        \begin{longtable}{|c|c|c|}
            ...
            \hline 
            \newpage
            Scrutatore & duergar (zemk) & Divoracervelli\\
            \includegraphics[width=4cm,height = 6cm]{../Mostri/Scrutatore.png} & \includegraphics[width=4cm,height = 6cm]{../Mostri/Duergar.png} &  \includegraphics[width=4cm,height = 6cm]{../Mostri/Divoracervelli.png}\\
            \hline
             Mind flayer & Melma Grigia & Mago apprendista\\
            \includegraphics[width=4cm,height = 6cm]{../Mostri/Mind_flayer.png} & \includegraphics[width=4cm,height = 6cm]{../Mostri/Melma_grigia.png} &  \includegraphics[width=4cm,height = 6cm]{../Mostri/Mago_apprendista.png}\\
         \end{longtable} 
    ...
    \begin{longtable}{|c|c|c|}
        ...
        \hline
        Druido & Esploratore& \\
        \includegraphics[width=4cm, height = 6 cm]{../Mostri/Druido.png} & \includegraphics[width=4cm, height = 6 cm]{../Mostri/Esploratore.png}&\\
        \hline
    \end{longtable}
