...
\subparagraph{Prigionieri} I tre popolani umani imprigionati quaggiù sono Mirna Dendrar
...
\item \textbf{Armeria} La porta di questa stanza è chiusa a chiave dall’esterno. Di
...
\subparagraph{Descrizione} Lungo le pareti di questa camera sono appoggiate varie
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item Leandra: se non ha già parlato di Cassiopea, rivela che è sua sorella
    \item Atalanta: la tortura sul fatto di essere stata abbandonata
...
\subparagraph{Sviluppi} I bugbear sono gli unici nel nascondiglio dei Marchi Rossi
...
\subparagraph{Descrizione}Alcuni vecchi tavoli e sedie sono sparpagliati in giro per questa
...
\subparagraph{Tesore} Le ricchezze di questa stanza sono tutte visibili sul tavolo,
...
\item \textbf{Laboratorio del mago} Da oltre le porte di questa stanza è possibile sentire il rumore
...
\subparagraph{Descrizione} Questa stanza sembra essere il laboratorio di un mago. Un
...
\subparagraph{Sviluppi} Dal momento che Iarno e il suo topo famiglio condividono un
legame telepatico, il mago (nell’area 12) sa che i personaggi
stanno arrivando e ha tempo di prepararsi ad affrontarli.
\subparagraph{Tesoro} La maggior parte del materiale contenuto in questa stanza
...
\item \textbf{Alloggi di Bastone di vetro} Se i personaggi raggiungono questa stanza dal passaggio
...
l’area 11 e il mago fugge prima che i personaggi arrivino. \newline \textbf{Descrizione} \textsc{ Le pareti di questa camera da letto sono ricoperte di drappi
